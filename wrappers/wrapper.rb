  ...
  class Wrapper
    ...
    def assert_no_pickup_timewindows_after_delivery_timewindows(vrp)
      vrp.shipments.empty? || vrp.shipments.none? { |shipment|
        ...
        first_open && last_close && (first_open ? first_open.start.to_i : 0) + 86400 * (first_open && first_open.day_index ? first_open.day_index : 0) > (last_close ? last_close.start.to_i : 0) + 86400 * (last_close && last_close.day_index ? last_close.day_index : 0)
      }
    end
