var fr = {
  translation: {
    ...
    delete: 'Supprimer',
    download_optim: 'Télécharger le rapport d\'erreur de l\'optimisation',
    download_optim_error: 'Télécharger le résultat de l\'optimisation',
...
var en = {
  translation: {
    ...
    delete: 'Delete',
    download_optim: 'Download the optimization error report',
    download_optim_error: 'Download the result of the optimization',
...
var es = {
  translation: {
    ...
    delete: 'Borrar',
    download_optim: 'Descargar el informe de errores de optimización',
    download_optim_error: 'Descargar el resultado de la optimización',
