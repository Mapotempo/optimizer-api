...
module Api
  module V01
    ...
    class VRPResultDetailCosts < Grape::Entity
    ...
    class VrpResultSolutionRoute < Grape::Entity
      ...
      expose :costs, using: VRPResultDetailCosts, documentation: { desc: 'The impact of the current route within the solution cost' }
    end
    ...
    class VrpResultSolution < Grape::Entity
      ...
      expose :costs, using: VRPResultDetailCosts, documentation: { desc: 'The detail of the different costs which impact the solution' }
