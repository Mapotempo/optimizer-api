...
module OptimizerWrapper
  ...
  CACHE = CacheManager.new(ActiveSupport::Cache::RedisStore.new(ENV['REDIS_HOST'] || 'localhost', namespace: 'mapotempo-optimizer-api', expires_in: 60*60*24*1))
  ...
  @@dump_vrp_cache = CacheManager.new(ActiveSupport::Cache::FileStore.new(File.join(Dir.tmpdir, 'mapotempo-optimizer-api'), namespace: 'mapotempo-optimizer-api-vrp', expires_in: 60*60*24*10))
