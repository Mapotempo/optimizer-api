...
class HeuristicTest < Minitest::Test
  if !ENV['SKIP_PERIODIC']
    ...
    def test_empty_underfilled_routes
      ...
      s = TestHelper.initialize_periodic_fully(vrp_to_solve)
    ...
    def test_compute_latest_authorized_day_2
      ...
      vrp = TestHelper.create(vrp)
      Interpreters::PeriodicVisits.new(OptimizerWrapper::PERIODIC_HEURISTIC, vrp) # call to function compute_possible_days
