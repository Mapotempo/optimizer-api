...
class ProcessInitialSolution(AbstractKnowledgeSource):
    ...
    def verify(self):
        ...
        if self.blackboard.cost_time_multiplier.shape[0] != self.blackboard.num_vehicles :
        ...
        if self.blackboard.cost_distance_multiplier.shape[0] != self.blackboard.num_vehicles :
        ...
        if self.blackboard.vehicle_capacity.shape[0] != self.blackboard.num_vehicles :
        ...
        if self.blackboard.vehicles_TW_starts.shape[0] != self.blackboard.num_vehicles :
        ...
        if self.blackboard.vehicles_TW_ends.shape[0] != self.blackboard.num_vehicles :
        ...
        if self.blackboard.vehicles_distance_max.shape[0] != self.blackboard.num_vehicles :
        ...
        if self.blackboard.vehicles_fixed_costs.shape[0] != self.blackboard.num_vehicles :
        ...
        if self.blackboard.vehicles_overload_multiplier.shape[0] != self.blackboard.num_vehicles :
        ...
        if self.blackboard.previous_vehicle.shape[0] != self.blackboard.num_vehicles :
        ...
        if self.blackboard.services_quantities is None:
            raise AttributeError("services_quantities vector is None, not possible to initialize a solution")
        if not isinstance(self.blackboard.services_quantities, numpy.ndarray):
            raise AttributeError("services_quantities vector is not of type numpy.array, not possible to initialize a solution")
        if self.blackboard.services_quantities.shape[0] != self.blackboard.num_services :
            raise AttributeError("Lengh of services_quantities vector is not equal to the number of services, not possible to initialize a solution")
    ...
    def process(self):
        ...
        self.blackboard.solution = cvrptw.CVRPTW(
            ...
            self.blackboard.distance_matrix,
            self.blackboard.time_matrix,
