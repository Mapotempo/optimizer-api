...
module Heuristics
  class Scheduling
    def initialize(vrp, real_schedule_start, schedule_end, shift, expanded_vehicles)
      # global data
    ...
    def clean_routes(service, day_finished, vehicle, days_available)
    ...
    def compute_tw_for_next(inserted_final_time, next_current_arrival, next_service_id, next_service_considered_setup, dist_from_inserted, current_day)
    ...
    def acceptable_for_group?(service, tw, shift)
    ...
    def insertion_cost_with_tw(tw, route_data, service, position)
    ...
    def compute_value_at_position(route_data, service, position, possibles, duration, position_in_order, filling_candidate_route = false)
